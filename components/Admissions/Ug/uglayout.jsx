...
const UgLayout = ({ eligibilityCriteria, title, overview }) => {
    const [openItems, setOpenItems] = React.useState(eligibilityCriteria.map(item => `item-${item.id}`))
            ...
            <div className="container mx-auto px-4 mt-10">
                <div className="max-w-5xl mx-auto">
                    ...
                    <h3 className='font-bold text-sm my-2'>
                        Multiple pathways to join our B. Tech Program
                            ...
                            {eligibilityCriteria.map((item) => {
                                ...
                                return (
                                    <AccordionItem
                                        key={item.id}
                                        value={`item-${item.id}`}
                                        className={` overflow-hidden border rounded-md ${item.borderColor}`}
                                    >
                                        <AccordionTrigger
